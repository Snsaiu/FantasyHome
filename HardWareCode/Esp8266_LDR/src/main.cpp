...
void setup()
{
  ...
  Serial.begin(9600);
  registFacade.Init("B5A97CB8-59C6-2F14-C2B4-C60E49E82E4A", "fantasyhome", "1234567890", "192.168.0.107", 1883);
}
...
void loop()
{
  ...
  //   //健康检查失败
  // }
  registFacade.MqttLoopWatch();

  registFacade.PublishMqttMessage("topic", "hello world");
  delay(2000);
