...
namespace FantasyHomeCenter.SysTimer.Services
{
    ...
    public class SysTimerService:ServiceBase<SysTimerEntity, SysTimerDto>, ISysTimerService, IScoped
    {
        ...
        /// <returns></returns>
        public override async Task<FantasyHomeCenter.Base.PagedList<SysTimerDto>> GetPage(int pageIndex = 1, int pageSize = 10)
        {
        ...
        /// <returns></returns>
        public override async Task<FantasyHomeCenter.Base.PagedList<SysTimerDto>> Search(FantasyHomeCenter.Base.PageRequest request)
        {
            var workers = SpareTime.GetWorkers().ToList();
