...
namespace FantasyHomeCenter.EntityFramwork.Audit.Domains
{
    /// <summary>
    /// 操作审计信息
    /// </summary>
    [Description("操作审计信息")]
    [IgnoreAudit]
    public class AuditOperation : Entity<Guid, MasterDbContextLocator, FantasyHomeCenterAuditDbContextLocator>
    {
        /// <summary>
        /// 审计操作
        /// </summary>
